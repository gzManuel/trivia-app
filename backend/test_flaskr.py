...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgres://manuel:1234@localhost:5432/{}".format(
            self.database_name)
    ...
    # This method is skiped because there's no other way to success than
    # deleting all categories, deleting all Categories generates erros to
    # others methods.
    @unittest.skip
    ...
    def test_404_search_question(self):
        res = self.client.post('/questions/search',
                               json={'searchTerm': 'I never be found'})
        data = json.loads(res.data)
